     ...
     <div class="min-h-screen py-2 pt-16 bg-gray-100 md:px-6 dark:bg-findDark-950">
         ...
         <div class="px-4 mt-4">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                ...
                                <li>
                                <Link :href="route('categoryName', service.category.slug)" class="items-center">

                                    <span class="ml-1 text-sm text-gray-500 font-bega-medium md:ml-2 dark:text-gray-400">{{service.category.name}}</span>
                                </Link>
                                </li>
                                 <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-1 text-sm text-gray-500 font-bega-medium md:ml-2 dark:text-gray-400">{{ service.service_numero }}</span>
                                    </div>
                                    </li>
                            </ol>
                            </nav>
        ...
        <div class="container relative px-4 py-4 lg:mx-auto">
            ...
            <div class="relative flex flex-col gap-4 lg:flex-row lg:space-x-4">
                <div id="card" class="relative flex-col mx-2 mb-6 lg:flex lg:order-2 lg:mb-0 lg:w-1/3">
                    <div class="flex lg:sticky lg:top-[8rem] flex-col gap-2 p-4 card-sticky ">
                        ...
                        <div class="mt-2 sm:col-span-8 lg:col-span-7">
                                ...
                                <h2 class="block my-4 text-base text-gray-800 truncate font-bega-semibold lg:text-lg lg:hidden dark:text-gray-300 ">
                                {{ service.title }}
                                </h2>
                            <section aria-labelledby="information-heading" class="mt-1 ">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ml-3 text-sm font-bega-medium text-amber-600 hover:text-indigo-500">{{ service.orderCount }}
                                        reviews</a>
                                </div>
                            ...
                            <div v-if="service.premium_price && service.extra_price " class="mt-4 mb-3">
                                <ul
                                    class="flex items-center w-full text-sm text-gray-900 bg-white border border-gray-200 rounded-lg font-bega-medium dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    <li class="w-full sm:border-r dark:border-gray-600" @click="level = 'Basic'"
                                        ...
                                        <button @click="changePrice(service.basic_price)"
                                            class="w-full py-3 ml-2 text-sm text-gray-900 font-bega-medium dark:text-gray-200 focus:outline-none">
                                            Basic
                                        </button>
                                    </li>
                            ...
                            <div class="flex justify-between gap-2 px-4 ">
                                <p class="py-2 text-lg text-gray-800 dark:text-gray-200">{{ level }} </p>
                                <p class="text-lg font-bega-semibold text-amber-600">{{price}} $</p>
                            </div>
                            ...
                            <div>
                                <div class="flex justify-between mt-4">
                                    <p class="flex gap-2 text-gray-700 font-bega-medium dark:text-gray-100">
                                ...
                                <div class="flex">
                                    <button @click="addToCart()" type="button" id=""
                                        class="flex items-center justify-center w-full gap-1 px-8 py-3 mt-4 text-base text-white border border-transparent bg-skin-fill font-bega-medium focus:outline-none focus:ring-2 focus:ring-offset-2">
                            ...
                            <div class="grid w-full gap-2 p-6 bg-white rounded-lg dark:bg-findDark-900">
                ...
                <div class="w-full px-2 lg:px-4 bg-gray-50 dark:bg-findDark-900 md:w-2/3">
                    <div class="lg:p-4 dark:bg-findDark-900">
                        <div class="flex flex-col mb-4">

                            <div>
                                <p class="mb-4 text-lg text-gray-700 font-bega-semibold md:text-xl dark:text-gray-200">
                                    {{service.title}}
                                </p>
                            </div>
                                ...
                                <div class="flex gap-4 mt-2">
                                    ...
                                    <div class="flex flex-col gap-3 my-auto">
                                        <a class="hidden text-base text-gray-500 font-bega-medium">{{ service.freelance.nom }}</a>
                                        <div class="flex flex-row gap-2">

                                            <span class="hidden text-base font-bega-medium">Niveau {{ service.freelance.level }}

                                            </span>

                                            <span  v-if="service.commandeEncours !=0" class="text-base font-bega-medium">
                                    ...
                                    <div class="mt-4">
                                            ...
                                            <img v-else class="object-cover w-auto h-auto rounded-md lg:h-10/12 swiper-lazy"
                                                            :src = "props.service.data.url_default"
                                    ...
                                    <div class="hidden">
                                            <p class="mt-4 text-lg text-gray-800 font-bega-semibold md:text-2xl dark:text-gray-200">
                                        {{ service.title }}</p>
                                            ...
                                            <TabPanel header="INFO">
                                                ...
                                                <div  class="py-5 min-h-64">
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                                        <div v-if='service.basic_support !=null'>
                                                            <p class="text-gray-500 font-bega-semibold dark:text-gray-200">Support :</p>
                                                    ...
                                                    <div class="grid hidden grid-cols-2 gap-4 mb-4">
                                                        <div>
                                                            <p class="text-gray-500 font-bega-semibold dark:text-gray-200">Prix :</p>
                                                            <p class="px-2 mt-2 text-gray-700 dark:text-gray-300">à partir de
                                                                <span class="text-lg text-green-700">{{ service.price }}</span>
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <p class="text-gray-500 font-bega-semibold dark:text-gray-200">Délai :</p>
                                                    ...
                                                    <div v-if="service.need_service !=null" class="grid grid-cols-2 gap-4 mb-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="flex items-center gap-2">
                                                                    <Photo :user="commentaire.user" taille="10" />
                                                                     <div>
                                                                            <p class="text-gray-800 font-bega-semibold dark:text-gray-200">Georges</p>
                                                                    </div>
                            ...
                            <div class="px-4 mt-6 border-t ">
                                <p class="pt-4 mb-4 text-lg text-gray-800 font-bega-medium dark:text-gray-200">À propos du freelance
                                </p>
                                <div class="flex items-center gap-4 mb-8">
                                   ...
                                   <Photo :user="service.user" />
                                    ...
                                    <div>
                                        <Link :href="route('profileFreelance', service.freelance.identifiant)" class="text-gray-800 font-bega-semibold dark:text-gray-300">
                                ...
                                <div class="max-w-md text-base text-gray-700 break-words dark:text-gray-100">
         ...
         <div class="px-4 mt-4">
            <div class="px-4">
                <p class="text-lg text-gray-800 font-bega-semibold dark:text-gray-200">Du meme Categorie</p>
            </div>
            ...
            <div class="grid gap-4 px-4 py-4 mx-auto md:grid-cols-4">
                ...
                <div v-if="props.otherService == null" class="flex items-center justify-center h-64">
                    <span class="text-lg text-gray-500 font-bega-medium">
