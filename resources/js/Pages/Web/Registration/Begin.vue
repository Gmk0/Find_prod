            ...
            <div class="px-6 m-auto text-gray-900 xl:container md:px-12 xl:px-16">
                <div
                    ...
                    <div class="md:7/12 lg:w-1/2">
                        ...
                        <div>
                            <Link :href="route('register.etape.1')" class="block w-full select-none rounded-lg bg-skin-fill py-2 px-2 text-center align-middle font-bega-medium text-sm uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-amber-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
