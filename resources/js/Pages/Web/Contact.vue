<template>
     ...
     <div class="min-h-screen pt-20 mx-auto font-bega-light max-w-7xl lg:px-8">

        <BreadCumbWeb link1="Contact" />
            <section
                ...
                <div class="container px-4 mx-auto">
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full px-4">
                            <div class="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
                                ...
                                <p class="text-base font-bega-medium">
                                      Besoin de plus d'information contacter nous
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 p-4 bg-white rounded-lg dark:bg-gray-800 md:grid-cols-2">
                        <div>
                            ...
                            <h2 class="mt-4 text-base text-gray-800 font-bega-medium dark:text-white">Email</h2>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Notre équipe amicale est ici pour vous aide</p>
                        ...
                        <div class="hidden">
                            ...
                            <h2 class="mt-4 text-base text-gray-800 font-bega-medium dark:text-white">Live chat</h2>
                        ...
                        <div>
                            ...
                            <h2 class="mt-4 text-base text-gray-800 font-bega-medium dark:text-white">Office</h2>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Venez dire bonjour à notre siège social.</p>
                            <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">63,avenue Colonel Mondjiba , Kinshasa-RDC
                                AU
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <h2 class="mt-4 text-base text-gray-800 font-bega-medium dark:text-white">Phone</h2>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Du lundi au Dimanche de 8h à 20h.</p>
