<template>
    <div class="min-h-screen pt-20 mx-auto max-w-7xl lg:px-8">
        ...
        <BreadCumbWeb link1="Tutorial" routeName="tutorial" link2="freelance" />
        <section class="relative  overflow-hidden pt-8 pb-12  lg:pb-[90px]">
            ...
            <h2  :class="{ 't text-amber-600': expandedItems.includes(index) }">
                ...
                <span class="max-w-xs break-words md:max-w-lg text-start">{{tuto.titre}}</span>
                <svg :class="{'rotate-180':!expandedItems.includes(index) ,'rotate-0': expandedItems.includes(index) }" class="w-3 h-3 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                ...
                <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
                    <div class="py-5 border-b border-gray-400 dark:border-gray-700">
                        ...
                        <div class="flex flex-col">
                            <div  class="w-[75%] h-48 mx-auto my-4 aspect-w-16 aspect-h-9 md:col-span-3 rounded-2xl">
