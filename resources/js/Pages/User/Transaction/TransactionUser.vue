...
<template>
   <div class="flex flex-col min-h-screen gap-6 px-4 lg:mx-auto md:p-6 md:max-w-7xl md:container px-auto bg-inherit">
        ...
        <div class="flex flex-col">
                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-bega-medium text-gray-500 md:ml-2 dark:text-gray-400">Transactions</span>
                        </div>
                        </li>
                    </ol>
                </nav>
            ...
            <h1 class="mt-4 text-3xl text-black font-bega-semibold dark:text-white">Transactions</h1>
