                            ...
                            <ul class="mt-6 space-y-1.5 ">
                                <li>
                                    <Link :href="route('profile.show')"
                                        ...
                                        <span
                                            :class="$page.component.startsWith('Profile/Show') ? 'dark:text-white text-slate-800' : 'transition-colors text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Comptes
                                            Utilisateur</span>
                                    </Link>
                                </li>
                                ...
                                <li>
                                    <Link :href="route('user.parainage')"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            :class="$page.component.startsWith('User/Profile/Parainage') ? 'dark:text-white text-slate-800' : 'transition-colors text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'"
                                            class="w-5 h-5 " fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                            stroke-width="1.5">
                                        ...
                                        <span
                                            :class="$page.component.startsWith('User/Profile/Parainage')  ? 'dark:text-white text-slate-800' : 'text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Parainage</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link :href="route('user.notifications')"
                                        ...
                                        <span
                                            :class="$page.component.startsWith('User/Profile/NotificationSetting') ? 'dark:text-white text-slate-800' : 'text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Notification</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link :href="route('user.security')"
                                        ...
                                        <span
                                            :class="$page.component.startsWith('User/Profile/Security') ? 'dark:text-white text-slate-800' : 'transition-colors text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Securité</span>
                                    </Link>
                                </li>
