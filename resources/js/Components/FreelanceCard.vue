...
<template>
    ...
    <div class="m-1 lg:mx-0">
        <div class="relative flex w-full min-w-[19rem] flex-col font-bega-light rounded-xl bg-white dark:bg-gray-900 bg-clip-border text-gray-700 shadow-lg">
            <div
                class="relative h-[16rem] mx-4 mt-2 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                ...
                <img v-if="props.freelance.user.profile_photo_path != null"   class="w-full h-full object-fit"  :src="'/storage/' + props.freelance.user.profile_photo_path" :alt="props.freelance.user.name" />
