...
<template>
    ...
    <main class="flex flex-col w-full font-bega-light  mt-0 main-content h-[100vh] chat-app"
            ...
            <div class="flex items-center space-x-5">
                <div class="ml-1 h-7 w-7">
                    <button
                        ...
                        :class="layoutStore.isSidebarExpanded && 'active'" @click="layoutStore.toogleRight()">
                        <span></span>
                        <span></span>
                        <span></span>
                    </button>
                ...
                <div @click="isShowChatInfo = true" class="flex items-center space-x-4 cursor-pointer font-inter">
                    ...
                    <div>
                        <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100"> {{user?.name}}</p>
        ...
        <div class="grow overflow-y-auto scrollbar-sm px-[calc(var(--margin-x)-.5rem)] py-5 transition-all duration-[.25s]"
            ref="scrollContainer" @scroll="handleScroll">
            <transition enter-class="transition-all duration-500 easy-in-out"
                enter-active-class="transition-all duration-500 easy-in-out"
                enter-to-class="opacity-100 [transform:translate3d(0,0,0)]">
                <div v-if="groupedMessages2" class="space-y-5">
                    ...
                    <template v-for="(messages, date) in groupedMessages2" :key="date">
                        ...
                        <div v-for="(groupedMessage, index) in messages" :key="index">
                            <div :class="groupedMessage.message.receiver_id == props.user.id ?'justify-end ':'items-start'"
                                ...
                                <div class="flex flex-col items-start space-y-3.5">
                                    <div :class="groupedMessage.message.receiver_id == props.user.id ? 'ml-4 md:ml-10 ':'mr-4 sm:mr-10'"
                                        class="max-w-lg">

                                        <div class="flex" @mouseenter="showChild = groupedMessage.message.id"
                                            @mouseleave="showChild = null">
                                            <div v-if="groupedMessage.message.receiver_id == props.user.id"
                                                class="flex mx-1">
                                                <Dropdown align="right" width="48">
                                                    <template #trigger>
                                                        <button v-if="showChild === groupedMessage.message.id"
                                                    ...
                                                    <template #content>
                                                        <button @click="deleteMessage(groupedMessage.message)"
                                                            class="flex items-center w-full gap-4 px-4 py-2 text-sm leading-5 text-left text-gray-700 transition duration-150 ease-in-out dark:text-gray-50 hover:dark:bg-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100">
                                        ...
                                        <div v-if="groupedMessage.message.service !=null">
                                            ...
                                            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Ce message est lié
                                                à un service :</p>
                                            ...
                                            <div class="flex flex-col">
                                                <div
                                                    ...
                                                    <Link
                                                        :href="route('oneService', [groupedMessage.message.user_service.slug, groupedMessage.message.service.slug])"
                                                        class="truncate hover:text-amber-500 ">{{
                                                    groupedMessage.message.service.title }}</Link>
                                                </div>
                                                <div
                                                    class="p-2 bg-gray-200 border-t border-gray-300 rounded-b-lg shadow-sm dark:bg-navy-700">



                                                    <template
                                                        v-if="$page.props.auth.user.id != groupedMessage.message.user_service.id">
                                                        <Button size="small" outlined
                                                            @click="DiscuterPrice(groupedMessage.message.service.id)"
                                                            label="Discuter prix" />
                                                    </template>
                                        ...
                                        <span class="flex items-center justify-end"
                                            v-if="groupedMessage.message.temporary != null">
                                            ...
                                            <template v-if="isImage(groupedMessage.message.file[0])">
                                                <div class="relative mt-2 group">
                                                    <img class="object-cover rounded-lg h-44"
                                                        :src="'/storage/'+ groupedMessage.message.file[0]"
                                                        alt="image" />
                                                    ...
                                                    <div
                                                        ...
                                                        <a :href="'/storage/' + groupedMessage.message.file[0]"
                                                            target="_blank"
                                        ...
                                        <p v-if="getHourFromDate(groupedMessage.message.created_at) !=='NaN:NaN'"
                                            :class="groupedMessage.message.receiver_id == props.user.id ?' text-left':'text-right'"
                ...
                <div class="flex flex-col items-center justify-center mt-8">
                    <div class="flex flex-col items-center mx-4 space-x-3">
                        ...
                        <div class="p-2 bg-yellow-100 rounded-md">
                            <p class="text-lg text-gray-800">Pour plus de sécurité et votre protection, effectuez les
                                paiements et les
                                communications
                                directement
                                sur FIND.</p>
        ...
        <div v-if="isShowChatInfo" class="fixed sidebar-user right-0 top-0 z-[101] h-full w-full sm:w-80">
            ...
            <transition enter-class="ease-out transform-gpu " enter-to-class="duration-500 translate-x-0"
                enter-active-class="translate-x-full" leave-class="ease-in transform-gpu" leave-to-class="translate-x-0"
                leave-active-class="-translate-x-full">
                <div v-if="isShowChatInfo"
                    class="flex flex-col w-full h-full transition-transform duration-200 bg-white border-l border-slate-150 dark:border-navy-600 dark:bg-navy-750">
                    ...
                    <div class="flex flex-col items-center mt-5">
                        ...
                        <h3 v-text="user?.name" class="mt-2 text-lg font-medium text-slate-700 dark:text-navy-100"></h3>
                        <p></p>
                                                ...
                                                <template v-if="!isImage(message.file[0])">
                                                    ...
                                                    <a :href="'/storage/' + message.file[0]" target="_blank"
                                                        ...
                                                        <div class="block max-w-md">
                                                            <p
                                                                class="block font-medium break-before-auto text-slate-700 dark:text-navy-100">
        ...
        <Dialog v-model:visible="visible" position="bottom" modal header="Fichier" :style="{ width: '50rem' }"
            :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">

            <div>
                <div class="card">
                    <Toast />
                    <FileUpload name="demo[]" :auto="true" @select="onSelect" :multiple="true" :maxFileSize="5000000">
                ...
                <div class="mt-1">
                    ...
                    <MazInput v-model="form.message" placeholder="Rajouter un message" />
        ...
        <Dialog v-model:visible="proposalModal" position="bottom" modal header="Proposer un prix "
            ...
            <div>
                <form @submit.prevent="sendPropasal">
                    <div class="p-2 mb-4">
                        ...
                        <MazInputNumber v-model="proposal.price" placeholder="Proposer un prix" />
        ...
        <Dialog v-model:visible="acceptProposalModal" position="bottom" modal header="Accepter prix "
            :style="{ width: '30rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
        ...
        <Dialog v-model:visible="refuserProposalModal" position="bottom" modal header="Refuser prix "
            :style="{ width: '30rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
            ...
            <div>
                <form @submit.prevent="declinePropasal">
                    ...
                    <div class="flex gap-4">
                        ...
                        <Button type="submit" severety="danger" outlined label="Refuser" />
                    </div>
        ...
        <Dialog v-model:visible="chooseProposal" position="bottom" modal header="Changer prix "
            :style="{ width: '30rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
            ...
            <div>
                <form @submit.prevent="changePrice">
                    <div class="mb-4">
                        ...
                        <MazInputNumber v-model="proposal.price" placeholder="Prix du service" />
