<template>
    <div  v-if="$page.props.flash.message">
        ...
        <div id="alert-additional-content-3" class="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
          ...
          <div class="mt-2 mb-4 text-sm font-bega-light">
        {{ $page.props.flash.message }}
          </div>
          <div class="flex">
            <button type="button" class="text-white hidden bg-green-800 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
