                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                    <table class="w-full s-10" role="presentation" border="0"
                                                    ...
                                                    <table class="p-6 space-y-4 card p-lg-10" role="presentation"
                                                        border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 14px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <table class="p-3 btn btn-primary fw-700"
                                                    ...
                                                    <div class="text-center text-muted" style="color: #718096;"
                                                        align="center">
                                                        <div
