                                            ...
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;"
                                                                        align="center" bgcolor="#dc3545" width="192">
                                                                        <a href="https://www.find-freelance.com/"
                                                                            style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #dc3545; padding: 8px 24px; border: 1px solid #dc3545;">Voir
                                                                            l'evolution de la commande</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <table class="px-4 py-8 card rounded-3xl p-lg-10"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 20px; margin: 0; padding: 44px;"
                                                                    ...
                                                                    <h3 class="text-center"
                                                                        ...
                                                                        align="center">Reçu de la part de FIND</h3>
                                                                    ...
                                                                    <table class="w-full p-2" border="0" cellpadding="0"
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td class="fw-700 border-top"
                                                                                    style="line-height: 20px; font-size: 14px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%;  margin: 0; padding: 8px;"
                                                                                    align="left" width="100%">Date
                                                                                    paiement le {{$orders->created_at}}
                                                                                </td>
                                                                    ...
                                                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">Si vous avez des questions,
                                                                        contactez nous <a
                                                                            href="https://bootstrapemail.com"
                                                                            style="color: #0d6efd;"><span
                                                                                class="__cf_email__"
                                                                                data-cfemail="d79fbea794b8a5a797b2afb6baa7bbb2f9b4b8ba">support@find-freelance.com</span></a>.
                                                                    </p>
                                                                </td>
                                                            </tr>
