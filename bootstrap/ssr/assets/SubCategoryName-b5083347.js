...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative w-full min-h-screen pb-12 pt-14" }, _attrs))}><div class="relative flex items-center justify-between px-4 py-4 lg:px-12 dark:bg-gray-800 bg-skin-fill"><div class="flex items-center justify-center"><h1 class="text-lg text-white font-bega-semibold lg:text-4xl">${ssrInterpolate(props.subcategory.name)}</h1></div><div class="flex">`);
