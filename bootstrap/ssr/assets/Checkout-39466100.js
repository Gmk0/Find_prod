...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="min-h-screen py-5 pt-16 overflow-y-auto custom scrollbar bg-gray-50 min-w-screen dark:bg-gray-900"><div class="px-2 md:px-12"><div><div class="mb-2"></div><div class="mb-2"><h1 class="text-5xl font-bold text-gray-600 md:text-2xl dark:text-gray-200">Panier</h1></div></div><div>`);
      ...
      if (items.value.length > 0) {
        ...
        _push(ssrRenderComponent(_component_MazInput, null, null, _parent));
