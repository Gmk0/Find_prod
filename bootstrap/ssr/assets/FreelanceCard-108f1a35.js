...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (props.freelance.user.profile_photo_path != null) {
        _push(`<img class="w-full h-full object-fit"${ssrRenderAttr("src", "/storage/" + props.freelance.user.profile_photo_path)}${ssrRenderAttr("alt", props.freelance.user.name)}>`);
      } else {
