...
import { d as cartStore, e as useStore, a as useCategoryStore, f as useSubcategoriesStore, _ as _sfc_main$6, b as _sfc_main$7 } from "./NotificationComponent-fe8292d8.js";
...
const Navbar_vue_vue_type_style_index_0_scoped_dd058d32_lang = "";
const _sfc_main$3 = {
  __name: "Navbar",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "z-[100]" }, _attrs))} data-v-dd058d32><div class="${ssrRenderClass([[
      ...
      ], "flex header-wrap !z-[100] classicHeader animated"])}" data-v-dd058d32><div class="w-full px-4 lg:px-12" data-v-dd058d32><div class="grid items-center justify-between w-full grid-cols-12 lg:mx-auto" data-v-dd058d32><div class="hidden logo md:col-span-2 lg:block" data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/images/optimize/find_02.png" class="hidden w-20 lg:block" alt="FInd" title="Find" data-v-dd058d32${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`</div><div class="col-span-3 lg:col-span-8" data-v-dd058d32><div class="block lg:hidden" data-v-dd058d32><button class="inline-flex items-center justify-center p-2 text-gray-700 rounded-md hover:text-white hover:bg-findDark-700 focus:outline-none focus:bg-findDark-700 focus:text-white" x-bind:aria-label="navOpen ? &#39;Close main menu&#39; : &#39;Main menu&#39;" x-bind:aria-expanded="navOpen" data-v-dd058d32><svg class="w-6 h-6" stroke="currentColor" fill="none" viewBox="0 0 24 24" data-v-dd058d32><path class="${ssrRenderClass([{ "hidden": navOpen.value, "inline-flex": !navOpen.value }, "inline-flex"])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-dd058d32></path><path class="${ssrRenderClass([{ "hidden": !navOpen.value, "inline-flex": navOpen.value }, "hidden"])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-dd058d32></path></svg></button></div><nav class="relative grid__item" id="AccessibleNav" data-v-dd058d32><ul id="siteNav" class="site-nav medium center hidearrow" data-v-dd058d32><li class="lvl1 parent megamenu" data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([{ "text-white ": !isSticky.value && !isNotHome.value, "lg:hidden dark:!text-white": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32${_scopeId}>Accueil</span><span class="${ssrRenderClass([{ "hidden dark:!text-white": !isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32${_scopeId}>Accueil</span>`);
          } else {
            return [
              createVNode("span", {
      ...
      _push(`</li><li class="lvl1 parent z-[60] megamenu" data-v-dd058d32><a href="" data-v-dd058d32><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Categories</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Categories</span></a><div class="flex w-full megamenu style4" data-v-dd058d32><div class="flex flex-col w-4/12 px-4 pt-10 pb-4 bg-white border border-gray-300 dark:bg-findDark-900 rounded-l-md min-h-72" data-v-dd058d32><!--[-->`);
      ssrRenderList(categories.value, (category) => {
        _push(`<div class="${ssrRenderClass([{ "bg-findDark-200 dark:bg-findDark-800 dark:text-skin-fill text-skin-fill ": selectedCategory.value === category }, "flex gap-4 px-2 py-4 text-gray-900 dark:text-gray-100 hover:text-skin-fill"])}" data-v-dd058d32>`);
        _push(ssrRenderComponent(_sfc_main$4, {
          illustration: category.illustration
        }, null, _parent));
        _push(`<h1 class="text-lg rounded-md cursor-pointer font-bega-medium" data-v-dd058d32>${ssrInterpolate(category.name)}</h1></div>`);
      });
      _push(`<!--]--></div>`);
      if (selectedCategory.value != null) {
        _push(`<div class="w-8/12 p-4 bg-white border border-gray-300 dark:bg-findDark-900 rounded-r-md min-h-72" data-v-dd058d32><h2 class="text-lg text-gray-900 cursor-pointer dark:text-gray-100 font-bega-medium" data-v-dd058d32>${ssrInterpolate(selectedCategory.value.name)}</h2><div class="flex justify-between" data-v-dd058d32><div class="mt-4" data-v-dd058d32><ul class="flex flex-wrap gap-6 text-gray-700 dark:text-gray-200 font-bega-light" data-v-dd058d32><!--[-->`);
      ...
      _push(`</div></li><li class="lvl1 parent dropdown" data-v-dd058d32><a href="#" data-v-dd058d32><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:text-black lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Freelance</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Freelance</span></a><ul class="dropdown dark:!bg-findDark-800" data-v-dd058d32><li data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</li></ul></li><li class="lvl1 parent dropdown" data-v-dd058d32><a href="#" data-v-dd058d32><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Mission</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Mission</span></a><ul class="dropdown" data-v-dd058d32><li data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</li></ul></li><li class="lvl1 parent dropdown" data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("Allservices")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32${_scopeId}>Services</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32${_scopeId}>Services</span>`);
          } else {
            return [
              createVNode("span", {
      ...
      _push(`</li><li class="lvl1 parent dropdown" data-v-dd058d32><a href="#" data-v-dd058d32><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>A propos</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>A propos</span></a><ul class="dropdown dark:!bg-findDark-900" data-v-dd058d32><li data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      if (hoverOpen.value) {
        _push(`<div class="absolute z-50 hidden w-full h-16 mx-auto right-4 top-16" data-v-dd058d32><div class="w-full h-24 max-w-5xl mx-auto mt-4 bg-red-300" data-v-dd058d32></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="block col-span-6 mx-auto lg:col-span-2 lg:hidden mobile-logo" data-v-dd058d32><div class="logo" data-v-dd058d32>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img style="${ssrRenderStyle(!isNotHome.value ? null : { display: "none" })}" class="flex w-20 dark:hidden" src="/images/optimize/find_03.png" alt="logo-find" data-v-dd058d32${_scopeId}><img style="${ssrRenderStyle(isNotHome.value ? null : { display: "none" })}" src="/images/optimize/find_02.png" alt="logo-find" class="w-24" data-v-dd058d32${_scopeId}><img style="${ssrRenderStyle(!isNotHome.value ? null : { display: "none" })}" class="hidden w-24 dark:flex" src="/images/optimize/find_02.png" alt="logo-find" data-v-dd058d32${_scopeId}>`);
          } else {
            return [
      ...
      _push(`</div></div><div class="flex items-center justify-end col-span-3 gap-2 lg:col-span-2" data-v-dd058d32>`);
      if (_ctx.$page.props.auth.user) {
        _push(`<div class="flex items-center gap-4" data-v-dd058d32>`);
        _push(ssrRenderComponent(_sfc_main$6, null, null, _parent));
        _push(ssrRenderComponent(_sfc_main$5, null, null, _parent));
        _push(`<div class="hidden site-cart" data-v-dd058d32><button type="button" class="search-trigger" data-v-dd058d32><svg style="${ssrRenderStyle(isNotHome.value ? null : { display: "none" })}" class="${ssrRenderClass([isSticky.value ? "dark:!text-white" : "!text-white dark:!text-white", "hidden w-5 h-5 lg:block"])}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-dd058d32><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-dd058d32></path></svg><svg style="${ssrRenderStyle(!isNotHome.value ? null : { display: "none" })}" class="hidden w-5 h-5 lg:block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-dd058d32><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-dd058d32></path></svg><svg class="block w-5 h-5 text-gray-700 dark:text-white lg:hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-dd058d32><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-dd058d32></path></svg></button></div><div class="hidden lg:block" data-v-dd058d32>`);
      ...
      if (!_ctx.$page.props.auth.user) {
        _push(`<div class="flex items-center gap-6 ml-2" data-v-dd058d32><a href="#" class="relative items-center justify-center hidden w-full h-12 px-2 mx-auto text-base bg-transparent rounded-full lg:flex group hover:scale-105 active:duration-75 active:scale-95 sm:w-max" data-v-dd058d32><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-dd058d32>Connexion</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white text-gray-800"])}" data-v-dd058d32>Connexion</span></a>`);
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="relative text-base font-semibold text-white dark:text-white underline-none" data-v-dd058d32${_scopeId}>S&#39;inscrire</span>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="relative text-base font-semibold text-amber-600" data-v-dd058d32${_scopeId}>S&#39;inscrire</span>`);
            } else {
              return [
      ...
      ])}" class="fixed inset-0 z-[400] bg-black bg-opacity-20 lg:hidden" data-v-dd058d32></div>`);
      if (navOpen.value) {
        _push(`<div style="${ssrRenderStyle({ "backdrop-filter": "blur(14px)", "-webkit-backdrop-filter": "blur(14px)" })}" class="fixed inset-0 bottom-0 left-0 z-[500] w-10/12 overflow-auto origin-left transform shadow-lg bg-findDark-200 dark:bg-findDark-900 custom-scrollbar lg:hidden" data-v-dd058d32><div class="sticky top-0 z-20 flex justify-between h-24 p-2 border-b border-gray-700 bg-findDark-200 dark:bg-findDark-900 dark:border-gray-300" data-v-dd058d32><div class="flex p-3 mx-1" data-v-dd058d32>`);
        if (_ctx.$page.props.auth.user) {
          _push(`<div class="flex w-full text-left" data-v-dd058d32><div class="flex-shrink-0" data-v-dd058d32>`);
          if (_ctx.$page.props.auth.user.profile_photo_path != null) {
            _push(`<img class="w-12 h-12 rounded-full"${ssrRenderAttr("src", "/storage/" + _ctx.$page.props.auth.user.profile_photo_path)} alt="" data-v-dd058d32>`);
          } else {
            _push(`<img class="w-16 h-16 rounded-full"${ssrRenderAttr("src", _ctx.$page.props.auth.user.profile_photo_url)} alt="" data-v-dd058d32>`);
          }
          _push(`</div><div class="px-4 py-3" data-v-dd058d32><span class="block text-base text-gray-800 truncate dark:text-white" data-v-dd058d32>${ssrInterpolate(_ctx.$page.props.auth.user.name)}</span></div></div>`);
        } else {
          _push(`<div data-v-dd058d32><a href="#" class="relative flex items-center justify-center w-full h-12 px-8 mx-auto duration-300 rounded-full dark:border dark:border-white bg-skin-fill before:absolute before:inset-0 before:transition hover:scale-105 active:duration-75 active:scale-95 sm:w-max" data-v-dd058d32><span class="relative text-base font-semibold text-white" data-v-dd058d32>Connexion</span></a></div>`);
        }
        _push(`</div><div class="text-left" data-v-dd058d32><button class="btn btn-sm btn-circle btn-outline" data-v-dd058d32><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-dd058d32><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-dd058d32></path></svg></button></div></div><div class="p-4 overflow-auto custom-scrollbar" data-v-dd058d32><div class="flex flex-col" data-v-dd058d32><div class="flex-1 border-gray-800 dark:border-white custom-scrollbar" data-v-dd058d32><div class="pt-4 pb-3" data-v-dd058d32>`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("home"),
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32${_scopeId}><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" data-v-dd058d32${_scopeId}></path><polyline points="9 22 9 12 15 12 15 22" data-v-dd058d32${_scopeId}></polyline></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Accueil</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Devenir Prestataire</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(`<div class="relative" data-v-dd058d32><button type="button" class="flex flex-row items-center w-full px-3 py-2 mt-1 text-lg text-left text-gray-800 rounded-md font-bega-medium dark:text-gray-50 hover:dark:text-white hover:bg-findDark-200 dark:hover:bg-findDark-600 focus:dark:text-white focus:text-white focus:bg-amber-600" data-v-dd058d32><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25zM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-2.25z" data-v-dd058d32></path></svg><span class="ml-2" data-v-dd058d32>Categories</span><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([{ "rotate-180": open.value, "rotate-0": !open.value }, "w-5 h-5 px-1 mt-1 transform"])}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32><polyline points="6 9 12 15 18 9" data-v-dd058d32></polyline></svg></button>`);
        _push(ssrRenderComponent(unref(Collapse), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<!--[-->`);
              ssrRenderList(categories.value, (category) => {
                _push2(`<div data-v-dd058d32${_scopeId}><button class="flex items-center justify-between w-full px-3 py-2 mt-1 text-lg text-left text-gray-800 rounded-md font-bega-medium dark:text-gray-50 hover:dark:text-white hover:bg-findDark-200 dark:hover:bg-findDark-600 focus:dark:text-white focus:text-white focus:bg-amber-600" data-v-dd058d32${_scopeId}><span class="flex gap-2 ml-3" data-v-dd058d32${_scopeId}>`);
                if (!unref(isDark)) {
                ...
                _push2(`<span class="ml-3" data-v-dd058d32${_scopeId}>${ssrInterpolate(category.name)}</span></span><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([{ "rotate-180": expandedItems.value.includes(category.id), "rotate-0": !expandedItems.value.includes(category.id) }, "w-6 h-6 px-1 mt-1 transform"])}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32${_scopeId}><polyline points="6 9 12 15 18 9" data-v-dd058d32${_scopeId}></polyline></svg></button>`);
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      ssrRenderList(category.subcategories, (subcategory) => {
                        _push3(`<div class="px-8" data-v-dd058d32${_scopeId2}>`);
                        _push3(ssrRenderComponent(unref(Link), {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0118 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 004.5 9v.878m13.5-3A2.25 2.25 0 0119.5 9v.878m0 0a2.246 2.246 0 00-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0121 12v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6c0-.98.626-1.813 1.5-2.122" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Services</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM10.5 7.5v6m3-3h-6" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Trouver un Freelance</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 12l-3-3m0 0l-3 3m3-3v6m-1.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Soumettre une mission</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Apropos</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Foire aux Questions</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(`<button class="flex flex-row items-center px-3 py-2 mt-1 text-base text-gray-800 rounded-md font-bega-medium dark:text-gray-50 hover:dark:text-white hover:bg-findDark-200 dark:hover:bg-findDark-600 focus:dark:text-white focus:text-white" aria-label="Toggle color mode" data-v-dd058d32>`);
        if (!unref(isDark)) {
          _push(`<svg class="w-5 h-5 text-gray-800" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" data-v-dd058d32><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" data-v-dd058d32></path></svg>`);
        } else {
          _push(`<svg class="w-5 h-5 text-gray-200" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" data-v-dd058d32><path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd" data-v-dd058d32></path></svg>`);
        }
        if (!unref(isDark)) {
          _push(`<span class="ml-2 text-gray-800" data-v-dd058d32>Sombre</span>`);
        } else {
          _push(`<span class="ml-2 text-gray-200" data-v-dd058d32>Clair</span>`);
        }
        _push(`</button></div></div>`);
        if (_ctx.$page.props.auth.user) {
          _push(`<div class="container mt-4 border-t border-gray-800 dark:border-gray-50" data-v-dd058d32><div class="pt-2 pb-3" data-v-dd058d32>`);
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor" data-v-dd058d32${_scopeId}><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Dashboard</span>`);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32${_scopeId}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-dd058d32${_scopeId}></path><circle cx="12" cy="7" r="4" data-v-dd058d32${_scopeId}></circle></svg><span class="ml-2" data-v-dd058d32${_scopeId}>profile</span>`);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-dd058d32${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" data-v-dd058d32${_scopeId}></path></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Conversation </span>`);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
          ...
          if (_ctx.$page.props.auth.freelance) {
            _push(`<!--[--><a href="/freelance-gestion" class="flex flex-row items-center px-2 py-2 text-gray-800 font-bega-medium dark:text-gray-200 text-md focus:text-gray-900 dark:hover:text-gray-200 hover:text-gray-900 focus:outline-none dark:hover:bg-findDark-600" role="menuitem" data-v-dd058d32><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-dd058d32></path><circle cx="12" cy="7" r="4" data-v-dd058d32></circle></svg><span class="ml-2" data-v-dd058d32>Espace Freelance</span></a>`);
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32${_scopeId}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-dd058d32${_scopeId}></path><circle cx="12" cy="7" r="4" data-v-dd058d32${_scopeId}></circle></svg><span class="ml-2" data-v-dd058d32${_scopeId}>Conversation freelance</span>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
          ...
          _push(`<form data-v-dd058d32><button type="submit" class="flex flex-row items-center px-4 py-2 text-red-500 text-md hover:text-red-700 hover:bg-red-100 focus:outline-none focus:text-red-700 focus:bg-red-100" data-v-dd058d32><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dd058d32><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" data-v-dd058d32></path><polyline points="16 17 21 12 16 7" data-v-dd058d32></polyline><line x1="21" y1="12" x2="9" y2="12" data-v-dd058d32></line></svg> Deconnexion </button></form></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-dd058d32"]]);
