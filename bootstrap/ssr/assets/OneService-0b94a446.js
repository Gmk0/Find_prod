...
import { _ as _sfc_main$1 } from "./WebLayout-79ce6308.js";
...
import { d as cartStore } from "./NotificationComponent-a50edf8a.js";
import "@vueuse/core";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(TabPanel), { header: "INFO" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-5 min-h-64"${_scopeId2}><div class="mb-4 prose text-gray-800 md:text-base dark:text-gray-200"${_scopeId2}><div${_scopeId2}>${service.value.description}</div></div><div class="grid grid-cols-2 gap-4 mb-4"${_scopeId2}>`);
                  ...
                  if (service.value.need_service != null) {
                    _push3(`<div class="grid grid-cols-2 gap-4 mb-6"${_scopeId2}><div class="col-span-2"${_scopeId2}><p class="text-base text-gray-500 font-bega-semibold dark:text-gray-200"${_scopeId2}>Besoin pour ce service :</p><div class="prose"${_scopeId2}>${service.value.need_service}</div></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
