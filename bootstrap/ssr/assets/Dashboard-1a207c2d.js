...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col min-h-screen gap-6 lg:mx-auto md:p-6 md:max-w-7xl md:container px-auto dark:bg-inherit" }, _attrs))}><div class="flex flex-col"><h1 class="text-2xl font-bega-semibold">Tableau de Bord</h1></div><div class="grid grid-cols-2 gap-4 px-auto lg:grid-cols-4">`);
