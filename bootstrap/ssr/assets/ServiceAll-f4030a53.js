...
import "flowbite";
const ServiceAll_vue_vue_type_style_index_0_lang = "";
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="py-8 mx-2 mb-4 bg-white rounded-lg dark:bg-findDark-800 lg:mx-4"><div class="flex items-center justify-between px-4"><p class="text-xl font-bega_medium text-slate-700 dark:text-navy-100"> Les Services populaire </p><div class="flex gap-4"><button class="w-10 h-10 p-0 rounded-full btn2 prev-btn hover:bg-slate-300/20 focus:bg-slate-300/20 dark:active:bg-slate-300/25 active:bg-slate-100/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 19l-7-7 7-7"></path></svg></button><button class="w-10 h-10 p-0 rounded-full btn2 next-btn hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5l7 7-7 7"></path></svg></button></div></div><div class="mt-5 lg:mx-6 lg:p-4">`);
      _push(ssrRenderComponent(unref(Swiper), {
      ...
      _push(`</div></div><div class="py-8 mx-2 mb-4 bg-white rounded-lg dark:bg-findDark-800 lg:mx-4"><div class="flex items-center justify-between px-4"><p class="text-xl font-bega_medium text-slate-700 dark:text-navy-100"> Les Freelance populaire </p><div class="flex gap-4"><button class="w-10 h-10 p-0 rounded-full btn2 prev-btn hover:bg-slate-300/20 focus:bg-slate-300/20 dark:active:bg-slate-300/25 active:bg-slate-100/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 19l-7-7 7-7"></path></svg></button><button class="w-10 h-10 p-0 rounded-full btn2 next-btn hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5l7 7-7 7"></path></svg></button></div></div><div class="mt-5 lg:mx-2 lg:py-4">`);
      _push(ssrRenderComponent(unref(Swiper), {
        class: "flex px-4 py-8",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(props.freelances, (freelance) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-4 lg:mx-4" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(props.freelances, (freelance) => {
                return openBlock(), createBlock(unref(SwiperSlide), { class: "p-4 lg:mx-4" }, {
                  default: withCtx(() => [
                    createVNode(_sfc_main$3, { freelance }, null, 8, ["freelance"])
                  ]),
                  _: 2
