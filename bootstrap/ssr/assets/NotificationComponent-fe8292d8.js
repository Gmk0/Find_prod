                  ...
                  createVNode("div", { class: "rounded-t-lg bg-slate-100 text-slate-600 dark:bg-navy-800 dark:text-navy-200" }, [
                    ...
                    createVNode("div", { class: "flex px-3 overflow-x-auto is-scrollbar-hidden shrink-0" }, [
                      createVNode("button", {
                        ...
                        class: [activeTab.value === "tabAll" ? "border-primary  dark:border-accent bg-transparent text-primary dark:text-accent-light" : "border-transparent hover:text-slate-800 focus:text-slate-800 bg-transparent dark:hover:text-navy-100 dark:focus:text-navy-100", "shrink-0 rounded-none border-b-2 px-3.5 py-2.5"]
                      }, [
                        createVNode("span", null, "Tout")
                      ], 10, ["onClick"]),
                      createVNode("button", {
                        onClick: ($event) => activeTab.value = "Commande",
                        class: [activeTab.value === "Commande" ? "border-primary dark:border-accent text-primary dark:text-accent-light" : "border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100", "shrink-0 rounded-none border-b-2 px-3.5 py-2.5"]
                      }, [
                        createVNode("span", null, "Commande")
                      ], 10, ["onClick"]),
                      createVNode("button", {
                        onClick: ($event) => activeTab.value = "tabEvents",
                        class: [activeTab.value === "tabEvents" ? "border-primary dark:border-accent text-primary dark:text-accent-light" : "border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100", "shrink-0 rounded-none border-b-2 px-3.5 py-2.5"]
                      }, [
