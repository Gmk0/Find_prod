import { inject, ref, computed, resolveComponent, mergeProps, withCtx, createVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, createCommentVNode, createTextVNode, withModifiers, withDirectives, vModelText, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-2 pt-16 bg-gray-100 md:px-6 dark:bg-findDark-950" }, _attrs))}><div class="hidden px-2"> All/Service </div><div class="px-4 mt-4"><nav class="flex" aria-label="Breadcrumb"><ol class="inline-flex items-center space-x-1 md:space-x-3"><li>`);
      _push(ssrRenderComponent(_component_Link, {
        href: _ctx.route("categoryName", service.value.category.slug),
        class: "items-center"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="ml-1 text-sm text-gray-500 font-bega-medium md:ml-2 dark:text-gray-400"${_scopeId}>${ssrInterpolate(service.value.category.name)}</span>`);
          } else {
            return [
              createVNode("span", { class: "ml-1 text-sm text-gray-500 font-bega-medium md:ml-2 dark:text-gray-400" }, toDisplayString(service.value.category.name), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(` Jours Delai </p><p class="flex gap-2 text-gray-700 font-bega-medium dark:text-gray-100"><span><i class="pi pi-replay"></i></span>`);
      if (level.value === "basic") {
      ...
      _push(` Revisions </p></div><div class="flex"><button type="button" id="" class="flex items-center justify-center w-full gap-1 px-8 py-3 mt-4 text-base text-white border border-transparent bg-skin-fill font-bega-medium focus:outline-none focus:ring-2 focus:ring-offset-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"></path></svg><span>Ajouter au Panier</span></button></div></div></section></div><div class="grid w-full gap-2 p-6 bg-white rounded-lg dark:bg-findDark-900">`);
      ...
      _push(`</div></div></div></div><div class="w-full px-2 lg:px-4 bg-gray-50 dark:bg-findDark-900 md:w-2/3"><div class="lg:p-4 dark:bg-findDark-900"><div class="flex flex-col mb-4"><div><p class="mb-4 text-lg text-gray-700 font-bega-semibold md:text-xl dark:text-gray-200">${ssrInterpolate(service.value.title)}</p></div><div class="flex gap-4 mt-2"><div class="flex flex-col gap-3 my-auto"><a class="hidden text-base text-gray-500 font-bega-medium">${ssrInterpolate(service.value.freelance.nom)}</a><div class="flex flex-row gap-2"><span class="hidden text-base font-bega-medium">Niveau ${ssrInterpolate(service.value.freelance.level)}</span>`);
      if (service.value.commandeEncours != 0) {
        _push(`<span class="text-base font-bega-medium"><span class="text-green-600">${ssrInterpolate(service.value.commandeEncours)}</span> commande en cours </span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div><div class="mt-4"><div class="w-full rounded-lg lg:w-10/12">`);
      if (props.service.data.files.lenght !== 0) {
        ...
        _push(`<img class="object-cover w-auto h-auto rounded-md lg:h-10/12 swiper-lazy"${ssrRenderAttr("src", props.service.data.url_default)}${ssrRenderAttr("alt", props.service.data.title)}>`);
      }
      _push(`</div></div><div class="hidden"><p class="mt-4 text-lg text-gray-800 font-bega-semibold md:text-2xl dark:text-gray-200">${ssrInterpolate(service.value.title)}</p></div><div class="mt-8">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(TabPanel), { header: "INFO" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-5 min-h-64"${_scopeId2}><div class="mb-4 prose text-justify text-gray-800 md:text-base dark:text-gray-200"${_scopeId2}><div${_scopeId2}>${service.value.description}</div></div><div class="grid grid-cols-2 gap-4 mb-4"${_scopeId2}>`);
                  if (service.value.basic_support != null) {
                    _push3(`<div${_scopeId2}><p class="text-gray-500 font-bega-semibold dark:text-gray-200"${_scopeId2}>Support :</p><div id="support" class="text-gray-800"${_scopeId2}><div class="px-2 mt-2"${_scopeId2}><ul class="px-4 list-disc dark:text-gray-50"${_scopeId2}><!--[-->`);
                  ...
                  _push3(`</div><div class="grid hidden grid-cols-2 gap-4 mb-4"${_scopeId2}><div${_scopeId2}><p class="text-gray-500 font-bega-semibold dark:text-gray-200"${_scopeId2}>Prix :</p><p class="px-2 mt-2 text-gray-700 dark:text-gray-300"${_scopeId2}>à partir de <span class="text-lg text-green-700"${_scopeId2}>${ssrInterpolate(service.value.price)}</span></p></div><div${_scopeId2}><p class="text-gray-500 font-bega-semibold dark:text-gray-200"${_scopeId2}>Délai :</p><p class="text-gray-700 dark:text-gray-300"${_scopeId2}>${ssrInterpolate(service.value.basic_delivery_time)} jours </p></div></div><div class="grid grid-cols-2 gap-4 mb-4"${_scopeId2}></div>`);
                  if (service.value.need_service != null) {
                    _push3(`<div class="grid grid-cols-2 gap-4 mb-6"${_scopeId2}><div class="col-span-2"${_scopeId2}><p class="text-base text-gray-500 font-bega-semibold dark:text-gray-200"${_scopeId2}>Besoin pour ce service :</p><div class="text-base prose text-justify text-gray-700 dark:text-gray-300"${_scopeId2}>${service.value.need_service}</div></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
                  ...
                  return [
                    createVNode("div", { class: "py-5 min-h-64" }, [
                      createVNode("div", { class: "mb-4 prose text-justify text-gray-800 md:text-base dark:text-gray-200" }, [
                        createVNode("div", {
                          innerHTML: service.value.description
                        }, null, 8, ["innerHTML"])
                      ]),
                      createVNode("div", { class: "grid grid-cols-2 gap-4 mb-4" }, [
                        service.value.basic_support != null ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("p", { class: "text-gray-500 font-bega-semibold dark:text-gray-200" }, "Support :"),
                          createVNode("div", {
                            id: "support",
                            class: "text-gray-800"
                          }, [
                      ...
                      createVNode("div", { class: "grid hidden grid-cols-2 gap-4 mb-4" }, [
                        createVNode("div", null, [
                          createVNode("p", { class: "text-gray-500 font-bega-semibold dark:text-gray-200" }, "Prix :"),
                        ...
                        createVNode("div", null, [
                          createVNode("p", { class: "text-gray-500 font-bega-semibold dark:text-gray-200" }, "Délai :"),
                          createVNode("p", { class: "text-gray-700 dark:text-gray-300" }, toDisplayString(service.value.basic_delivery_time) + " jours ", 1)
                        ])
                      ]),
                      createVNode("div", { class: "grid grid-cols-2 gap-4 mb-4" }),
                      service.value.need_service != null ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "grid grid-cols-2 gap-4 mb-6"
                      }, [
                        createVNode("div", { class: "col-span-2" }, [
                          createVNode("p", { class: "text-base text-gray-500 font-bega-semibold dark:text-gray-200" }, "Besoin pour ce service :"),
                          createVNode("div", {
                            class: "text-base prose text-justify text-gray-700 dark:text-gray-300",
                          ...
                          _push4(ssrRenderComponent(unref(SwiperSlide), null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div${_scopeId4}><p class="text-gray-800 font-bega-semibold dark:text-gray-200"${_scopeId4}>Georges</p></div></div></div></div></div>`);
                              } else {
                                return [
                                  createVNode("div", null, [
                                    createVNode("div", { class: "p-4 mb-4 bg-gray-100 rounded-lg dark:bg-gray-600" }, [
                                      ...
                                      createVNode("div", null, [
                                        createVNode("div", { class: "flex items-center gap-2" }, [
                                          ...
                                          createVNode("div", null, [
                                            createVNode("p", { class: "text-gray-800 font-bega-semibold dark:text-gray-200" }, "Georges")
                                          ])
                                        ])
                                      ])
                                    ])
      ...
      _push(`</div><div class="px-4 mt-6 border-t"><p class="pt-4 mb-4 text-lg text-gray-800 font-bega-medium dark:text-gray-200">À propos du freelance </p><div class="flex items-center gap-4 mb-8">`);
      ...
      _push(ssrRenderComponent(_component_Link, {
        ...
        class: "text-gray-800 font-bega-semibold dark:text-gray-300"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<p class="block text-gray-700 truncate dark:text-gray-300">${ssrInterpolate(service.value.category.name)}</p></div></div><div class="max-w-md text-base text-gray-700 break-words dark:text-gray-100">${ssrInterpolate(service.value.freelance.description)}</div></div></div></div></div></div></div><div class="px-4 mt-4"><div class="px-4"><p class="text-lg text-gray-800 font-bega-semibold dark:text-gray-200">Du meme Categorie</p></div><div class="grid gap-4 px-4 py-4 mx-auto md:grid-cols-4"><!--[-->`);
      ...
      if (props.otherService == null) {
        _push(`<div class="flex items-center justify-center h-64"><span class="text-lg text-gray-500 font-bega-medium"> Aucun élément trouvé. </span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
                  ...
                  createVNode("div", { class: "flex flex-col gap-2" }, [
                    createVNode("div", { class: "flex flex-col gap-2" }, [
                      createVNode("div", {
                        ...
                        class: "p-1 transition bg-gray-100 rounded-lg cursor-pointer dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700"
                      }, [
