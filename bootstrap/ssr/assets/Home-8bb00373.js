...
import { _ as _sfc_main$2 } from "./WebLayout-79ce6308.js";
import { Swiper, SwiperSlide } from "swiper/vue";
import { e as useStore, i as homeSetting, j as useMissions } from "./NotificationComponent-a50edf8a.js";
                ...
                _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-2" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`</p><div class="grow"${_scopeId2}><div class="flex items-center mt-2 text-xs"${_scopeId2}><a href="#" class="flex items-center space-x-2 hover:text-slate-800 dark:hover:text-navy-100"${_scopeId2}><div class="w-12 h-12 mb-2"${_scopeId2}>`);
                            ...
                            createVNode("div", { class: "grow" }, [
                              createVNode("div", { class: "flex items-center mt-2 text-xs" }, [
                                createVNode("a", {
                                  ...
                                  createVNode("div", { class: "w-12 h-12 mb-2" }, [
