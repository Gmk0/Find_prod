...
import { _ as _sfc_main$2 } from "./WebLayout-e2e4e15e.js";
import { Swiper, SwiperSlide } from "swiper/vue";
import { e as useStore, i as homeSetting, j as useMissions } from "./NotificationComponent-fe8292d8.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="relative slide slideshow--medium"${_scopeId2}><div class="blur-up lazyload bg-size"${_scopeId2}><img class="blur-up lazyload bg-img" data-src="/canva/graceBrand.svg" src="/canva/graceBrand.svg" alt="graceP" title="graceP"${_scopeId2}><div class="slideshow__text-wrap slideshow__overlay classic middle"${_scopeId2}><div class="slideshow__text-content classic middle"${_scopeId2}><div class="container"${_scopeId2}><div class="wrap-caption right"${_scopeId2}><h2 class="h1 mega-title slideshow__title"${_scopeId2}></h2><span class="mega-subtitle slideshow__subtitle"${_scopeId2}></span><span class=""${_scopeId2}></span></div></div></div></div></div><div class="absolute flex flex-col floating gap-1 right-[30%] top-1/2"${_scopeId2}><h1 class="text-lg text-white font-bega-medium"${_scopeId2}>Grace K.</h1><p class="text-base text-white font-bega-medium"${_scopeId2}>Marketeuse Digital</p></div></div>`);
                } else {
                  return [
      ...
      _push(`</div></div></div><div id="monde2" class="xl:min-h-full lg:min-h-screen dark:bg-gray-900"><div class="p-4"><div class="px-6 m-auto text-gray-600 xl:container md:px-12 xl:px-16"><div class="flex-row-reverse justify-center p-4 space-y-6 bg-gray-100 rounded-lg dark:bg-gray-800 lg:p-16 md:flex md:gap-6 md:space-y-0 lg:items-center"><div data-aos="flip-left" data-aos-duration="500" class="md:5/12 lg:w-1/2"><img src="/images/services/presentation3.png" alt="image" class="rounded-lg dark:bg-gray-800 floating bg-skin-fill" loading="lazy" width="" height=""></div><div data-aos="fade-right" data-aos-duration="300" class="md:7/12 lg:w-1/2"><h2 class="text-2xl text-gray-900 font-bega-semibold md:text-4xl dark:text-white"> Trouvez dès aujourd&#39;hui la personne idéale pour votre projet ! </h2><p class="my-4 text-gray-600 dark:text-gray-300"></p><div class="space-y-4 divide-y divide-gray-100 font-bega-light dark:divide-gray-800"><div class="flex gap-4 mt-4 md:items-center"><div class="flex w-12 h-12 gap-4 rounded-full dark:bg-teal-900/20">`);
            ...
            if (_push2) {
              ...
              ssrRenderList(getMissions.value, (mission) => {
                _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-2" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="p-2 mb-4 rounded-md shadow-md lg:flex-col"${_scopeId2}><img class="object-cover object-center w-full h-48 bg-center bg-cover shrink-0" src="/images/illustrations/missionF.svg" alt="image"${_scopeId2}><div class="flex flex-col w-full px-4 py-3 bg-white dark:bg-gray-900 font-bega-light grow sm:px-5"${_scopeId2}><div class="flex items-center justify-between"${_scopeId2}><a class="text-xs+ font-medium text-info" href="#"${_scopeId2}>${ssrInterpolate(mission.category.name)}</a><div class="-mr-1.5 flex space-x-1"${_scopeId2}><button class="hidden p-0 rounded-full btn2 h-7 w-7 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"${_scopeId2}></path></svg></button><div class="p-2"${_scopeId2}></div></div></div><div${_scopeId2}>`);
                      ...
                      if (!showMore.value) {
                        _push3(`<div class="max-w-xs break-words font-bega-light"${_scopeId2}>${ssrInterpolate(truncateText(mission.description, 70))}</div>`);
                      } else {
                      ...
                      return [
                        createVNode("div", { class: "p-2 mb-4 rounded-md shadow-md lg:flex-col" }, [
                          ...
                          createVNode("div", { class: "flex flex-col w-full px-4 py-3 bg-white dark:bg-gray-900 font-bega-light grow sm:px-5" }, [
