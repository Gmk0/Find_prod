...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex gap-2"><div></div><div class=""><div class="block"><div class="relative flex">`);
      ...
      _push(ssrRenderComponent(unref(Collapse), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (form.value.category) {
              _push2(`<button class="absolute right-16 p-1 text-white z-[100] rounded top-[20%]"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId}></path></svg></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "relative flex" }, [
                ...
                form.value.category ? (openBlock(), createBlock("button", {
                  ...
                  class: "absolute right-16 p-1 text-white z-[100] rounded top-[20%]"
                }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    fill: "none",
